...
Hampl = repmat(1/SYS.btls,[1,nrofi]); % inverse identified model
...
bode_fdi({mdl.Pv(1,1),Pest(1,1)},[Pest.freq,Pest.UserData.FRFn(:,1)]);
legend('true','estimated frd','noise');
% bode_fdi({mdl.Pv(1,1),Pest_qlog(1,1)},[Pest_qlog.freq,Pest_qlog.UserData.FRFn(:,1)]);
